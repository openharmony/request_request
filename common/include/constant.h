...
enum ErrorCodeInner : int32_t {
    ERROR_CLIENT_NULL_POINTER = -10,
    ERROR_SERVICE_DUPLICATE_TASK_ID = -9,
    ERROR_SERVICE_NULL_POINTER = -8,
    ERROR_CLIENT_FILE_APTH_INVALID = -7,
    ERROR_CLIENT_FILE_PATH_EXISTS = -6,
    ERROR_CLIENT_FILE_IO = -5,
    ERROR_CLIENT_IPC_ERR = -4,
    ERROR_CLIENT_DEAD_REPLY = -3,
    ERROR_SERVICE_SA_QUITTING = -2,
    ERROR_SERVICE_NOT_INITIALISE = -1,
    ERROR_NO_ERR = 0,
};
