...
enum ErrorCodeInner : int32_t {
    ...
    ERROR_SERVICE_DUPLICATE_TASK_ID,
    ERROR_SERVICE_NULL_POINTER,
    ERROR_CLIENT_FILE_PATH_INVALID,
    ERROR_CLIENT_FILE_PATH_EXISTS,
    ERROR_CLIENT_FILE_IO,
    ERROR_CLIENT_IPC_ERR,
    ERROR_CLIENT_DEAD_REPLY,
    ERROR_SERVICE_SA_QUITTING,
    ERROR_SERVICE_NOT_INITIALIZE,
    ERROR_SERVICE_ERR,
