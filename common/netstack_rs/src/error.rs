...
//!
//! This module defines error types and codes used throughout the HTTP client
//! implementation, providing a consistent error handling mechanism across the
//! library.
...
pub enum HttpErrorCode {
    ...
    ///
    /// Occurs when attempting to use a protocol that the client doesn't
    /// support.
