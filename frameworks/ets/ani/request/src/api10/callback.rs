...
/// Collection of callbacks for different task events.
///
/// Manages callbacks for various task events including progress updates,
/// completion, pause, resume, removal, failure, and HTTP responses.
