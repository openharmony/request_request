...
napi_value DownloadResume::Restore(napi_env env, napi_callback_info info)
{
    ...
    return Exec(env, info, "restore");
}

napi_value DownloadResume::Exec(napi_env env, napi_callback_info info, const std::string &resourceName)
{
