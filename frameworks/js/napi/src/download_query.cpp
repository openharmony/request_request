...
napi_value DownloadQuery::GetTaskInfo(napi_env env, napi_callback_info info)
{
    ...
    return Exec(env, info, "getTaskInfo");
}

napi_value DownloadQuery::Exec(napi_env env, napi_callback_info info, const std::string &resourceName)
{
